...
class InsertViewModel(
    ...
    fun validateFields(): Boolean {
        ...
        val errorState = FormErrorState(
            ...
            judulSkripsi = if (event.judulSkripsi.isNotEmpty()) null else "Angkatan tidak boleh kosong",
            dosenPembimbing1 = if (event.dosenPembimbing1.isNotEmpty()) null else "Angkatan tidak boleh kosong",
            dosenPembimbing2 = if (event.dosenPembimbing2.isNotEmpty()) null else "Angkatan tidak boleh kosong",
...
data class FormErrorState(
    ...
    fun isValid(): Boolean {
        return nim == null && nama == null && jenisKelamin == null &&
                alamat == null && kelas == null && angkatan == null && judulSkripsi == null && dosenPembimbing1 == null
...
fun MahasiswaEvent.toMhsModel(): Mahasiswa = Mahasiswa(
    ...
    dosenPembimbing1 = dosenPembimbing2,
